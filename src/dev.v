...
/Users/frankanaba/Library/Containers/com.apple.mail/Data/Library/Mail Downloads/2F34C846-BFA0-4D3C-A858-198809DB765C/preorder.v
 *)
...
(forall a x :A, comp_pol x a = false -> comp_pol a x = true) -> equiv_pol A comp_pol l (f A comp_pol l) /\ sorted_pol comp_pol (f A comp_pol l).

(**Faire la preuve de pred_sort_pol**)
